...
```bash
curl https://care-pillar-fix.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://care-pillar-fix.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
