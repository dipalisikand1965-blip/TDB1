...
```bash
curl https://care-dine-parity.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://care-dine-parity.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
