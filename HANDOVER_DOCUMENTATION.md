...
```bash
curl https://pet-wrapped-1.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://pet-wrapped-1.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
