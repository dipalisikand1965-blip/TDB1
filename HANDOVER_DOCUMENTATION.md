...
- **Preview:** https://play-breed-tips.preview.emergentagent.com
...
```bash
curl https://play-breed-tips.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://play-breed-tips.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
