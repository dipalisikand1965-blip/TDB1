...
```bash
curl https://cms-architecture-lab.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://cms-architecture-lab.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
