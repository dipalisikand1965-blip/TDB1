...
```bash
curl https://dine-category-pills.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://dine-category-pills.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
