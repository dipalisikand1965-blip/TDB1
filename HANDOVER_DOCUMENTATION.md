...
```bash
curl https://dine-consistency-fix.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://dine-consistency-fix.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
