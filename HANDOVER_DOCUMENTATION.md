...
```bash
curl https://celebrate-sync-3.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://celebrate-sync-3.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
