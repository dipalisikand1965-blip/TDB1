...
```bash
curl https://urgent-pet-care-2.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://urgent-pet-care-2.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
