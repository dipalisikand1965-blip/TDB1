...
```bash
curl https://pet-life-os-2.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://pet-life-os-2.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
