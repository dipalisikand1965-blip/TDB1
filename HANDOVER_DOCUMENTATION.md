...
```bash
curl https://health-vault-loop.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://health-vault-loop.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
