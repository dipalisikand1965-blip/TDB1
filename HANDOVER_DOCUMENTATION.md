...
```bash
curl https://dine-layout-update.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://dine-layout-update.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
