...
|-------------|--------|---------------|
| **Razorpay** | ✅ LIVE | Key: `rzp_live_S6mTSKS8qWOi42` |
...
```env
RAZORPAY_KEY_ID=rzp_live_S6mTSKS8qWOi42
...
```bash
curl https://pillar-parity-sprint.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://pillar-parity-sprint.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
