...
```bash
curl https://panel-refresh-debug.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://panel-refresh-debug.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
