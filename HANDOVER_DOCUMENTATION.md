...
```bash
curl https://soul-made-admin.preview.emergentagent.com/api/whatsapp/status
```

### Test Service Listing
```bash
curl "https://soul-made-admin.preview.emergentagent.com/api/service-box/services?pillar=dine&limit=5"
```
