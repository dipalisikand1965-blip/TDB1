...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-soul-dash.preview.emergentagent.com').rstrip('/')
...
class TestFitPageEndpoints:
    ...
    def test_fit_request_endpoint_requires_auth(self):
        """Test /api/fit/request POST endpoint requires authentication"""
        payload = {
            "fit_type": "assessment",
