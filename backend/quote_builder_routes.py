...
@router.post("/create")
async def create_quote(request: CreateQuoteModel, username: str = Depends(verify_quote_admin)):
...
@router.put("/{quote_id}")
async def update_quote(quote_id: str, request: UpdateQuoteModel, username: str = Depends(verify_quote_admin)):
...
async def send_quote(quote_id: str, request: SendQuoteModel = None, username: str = Depends(verify_quote_admin)):
    ...
    notification = {
        ...
        "type": "quote_received",
        "title": "🎉 Your Party Quote is Ready!",
...
async def mark_quote_paid(
    ...
    username: str = Depends(verify_quote_admin)
):
    ...
    notification = {
        ...
        "message": "Thank you! Your party order has been confirmed. We'll start preparing everything!",
        "quote_id": quote_id,
        "read": False,
        "created_at": timestamp
    }
