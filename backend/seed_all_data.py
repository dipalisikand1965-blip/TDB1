...
# ============= CATEGORIES DATA =============
CATEGORIES = [
    {"id": "birthday_cakes", "name": "Birthday Cakes", "slug": "birthday-cakes", "icon": "🎂"},
    {"id": "treats", "name": "Treats", "slug": "treats", "icon": "🦴"},
    {"id": "fresh_meals", "name": "Fresh Meals", "slug": "fresh-meals", "icon": "🍖"},
    {"id": "frozen_treats", "name": "Frozen Treats", "slug": "frozen-treats", "icon": "🧊"},
