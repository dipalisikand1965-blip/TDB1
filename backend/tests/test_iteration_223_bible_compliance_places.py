...
Endpoint URL: https://soul-aware-picks.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://soul-aware-picks.preview.emergentagent.com').rstrip('/')
