...
Endpoint URL: https://memory-wall-debug.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://memory-wall-debug.preview.emergentagent.com').rstrip('/')
