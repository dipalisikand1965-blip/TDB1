...
Endpoint URL: https://learn-page-studio.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://learn-page-studio.preview.emergentagent.com').rstrip('/')
