...
Endpoint URL: https://mira-legacy.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-legacy.preview.emergentagent.com').rstrip('/')
