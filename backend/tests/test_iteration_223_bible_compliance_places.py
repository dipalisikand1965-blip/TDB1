...
Endpoint URL: https://health-vault-loop.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://health-vault-loop.preview.emergentagent.com').rstrip('/')
