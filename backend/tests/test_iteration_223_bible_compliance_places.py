...
Endpoint URL: https://learn-golden-2.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://learn-golden-2.preview.emergentagent.com').rstrip('/')
