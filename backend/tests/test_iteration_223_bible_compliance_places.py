...
Endpoint URL: https://pet-life-ai.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-life-ai.preview.emergentagent.com').rstrip('/')
