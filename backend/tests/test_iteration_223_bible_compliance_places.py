...
Endpoint URL: https://celebrate-products.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://celebrate-products.preview.emergentagent.com').rstrip('/')
