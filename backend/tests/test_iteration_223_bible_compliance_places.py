...
Endpoint URL: https://dine-places.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://dine-places.preview.emergentagent.com').rstrip('/')
