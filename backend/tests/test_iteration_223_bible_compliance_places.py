...
Endpoint URL: https://celebrate-showcase.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://celebrate-showcase.preview.emergentagent.com').rstrip('/')
