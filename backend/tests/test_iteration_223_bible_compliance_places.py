...
Endpoint URL: https://concierge-lab.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://concierge-lab.preview.emergentagent.com').rstrip('/')
