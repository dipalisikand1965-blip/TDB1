...
Endpoint URL: https://concierge-pet-os.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://concierge-pet-os.preview.emergentagent.com').rstrip('/')
