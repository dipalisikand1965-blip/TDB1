...
Endpoint URL: https://pet-life-admin.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-life-admin.preview.emergentagent.com').rstrip('/')
