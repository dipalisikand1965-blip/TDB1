...
Endpoint URL: https://play-breed-tips.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://play-breed-tips.preview.emergentagent.com').rstrip('/')
