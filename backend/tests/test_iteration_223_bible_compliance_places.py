...
Endpoint URL: https://play-ui-sync.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://play-ui-sync.preview.emergentagent.com').rstrip('/')
