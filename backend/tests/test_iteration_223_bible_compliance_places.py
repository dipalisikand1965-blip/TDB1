...
Endpoint URL: https://dynamic-cms-platform.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://dynamic-cms-platform.preview.emergentagent.com').rstrip('/')
