...
Endpoint URL: https://soul-groom.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://soul-groom.preview.emergentagent.com').rstrip('/')
