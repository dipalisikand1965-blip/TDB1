...
Endpoint URL: https://soul-concierge.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://soul-concierge.preview.emergentagent.com').rstrip('/')
