...
Endpoint URL: https://pet-ai-brain.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-ai-brain.preview.emergentagent.com').rstrip('/')
