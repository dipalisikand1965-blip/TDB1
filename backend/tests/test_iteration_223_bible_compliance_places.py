...
Endpoint URL: https://doggy-handover.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://doggy-handover.preview.emergentagent.com').rstrip('/')
