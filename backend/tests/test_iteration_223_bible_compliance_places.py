...
Endpoint URL: https://mobile-drawer-fix.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mobile-drawer-fix.preview.emergentagent.com').rstrip('/')
