...
Endpoint URL: https://watercolor-makeover.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://watercolor-makeover.preview.emergentagent.com').rstrip('/')
