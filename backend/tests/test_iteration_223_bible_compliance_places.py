...
Endpoint URL: https://doggy-fixes.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://doggy-fixes.preview.emergentagent.com').rstrip('/')
