...
Endpoint URL: https://pet-data-heal.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-data-heal.preview.emergentagent.com').rstrip('/')
