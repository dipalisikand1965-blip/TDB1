...
Endpoint URL: https://pet-os-auth-fix.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-os-auth-fix.preview.emergentagent.com').rstrip('/')
