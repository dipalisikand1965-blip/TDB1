...
Endpoint URL: https://soul-made-platform.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://soul-made-platform.preview.emergentagent.com').rstrip('/')
