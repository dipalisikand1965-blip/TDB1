...
Endpoint URL: https://pet-parent-signup.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-parent-signup.preview.emergentagent.com').rstrip('/')
