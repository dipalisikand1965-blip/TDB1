...
Endpoint URL: https://mira-picks-engine.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-picks-engine.preview.emergentagent.com').rstrip('/')
