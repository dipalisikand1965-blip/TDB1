...
Endpoint URL: https://paw-concierge.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://paw-concierge.preview.emergentagent.com').rstrip('/')
