...
Endpoint URL: https://learn-hub-popup.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://learn-hub-popup.preview.emergentagent.com').rstrip('/')
