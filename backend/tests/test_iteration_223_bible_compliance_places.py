...
Endpoint URL: https://concierge-flow.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://concierge-flow.preview.emergentagent.com').rstrip('/')
