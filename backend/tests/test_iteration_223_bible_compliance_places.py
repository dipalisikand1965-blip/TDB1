...
Endpoint URL: https://decision-support-8.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://decision-support-8.preview.emergentagent.com').rstrip('/')
