...
Endpoint URL: https://celebrate-bundles.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://celebrate-bundles.preview.emergentagent.com').rstrip('/')
