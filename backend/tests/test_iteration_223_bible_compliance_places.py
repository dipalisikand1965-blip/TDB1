...
Endpoint URL: https://concierge-core.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://concierge-core.preview.emergentagent.com').rstrip('/')
