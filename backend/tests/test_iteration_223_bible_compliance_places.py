...
Endpoint URL: https://mira-ai-soul.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-ai-soul.preview.emergentagent.com').rstrip('/')
