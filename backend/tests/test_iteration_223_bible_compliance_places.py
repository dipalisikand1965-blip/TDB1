...
Endpoint URL: https://soul-picks-engine.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://soul-picks-engine.preview.emergentagent.com').rstrip('/')
