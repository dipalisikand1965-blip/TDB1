...
Endpoint URL: https://pet-concierge-ai.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-concierge-ai.preview.emergentagent.com').rstrip('/')
