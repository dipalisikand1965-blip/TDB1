...
Endpoint URL: https://cms-architecture-lab.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://cms-architecture-lab.preview.emergentagent.com').rstrip('/')
