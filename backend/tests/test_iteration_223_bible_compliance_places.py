...
Endpoint URL: https://feature-parity-push.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://feature-parity-push.preview.emergentagent.com').rstrip('/')
