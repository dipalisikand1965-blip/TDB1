...
Endpoint URL: https://unified-dine.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://unified-dine.preview.emergentagent.com').rstrip('/')
