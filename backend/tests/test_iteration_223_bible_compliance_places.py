...
Endpoint URL: https://soul-made-admin.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://soul-made-admin.preview.emergentagent.com').rstrip('/')
