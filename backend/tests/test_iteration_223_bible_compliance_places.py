...
Endpoint URL: https://mira-memory-cards.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-memory-cards.preview.emergentagent.com').rstrip('/')
