...
Endpoint URL: https://pet-wrapped.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-wrapped.preview.emergentagent.com').rstrip('/')
