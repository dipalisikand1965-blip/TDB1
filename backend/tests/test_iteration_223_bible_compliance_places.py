...
Endpoint URL: https://product-box-refactor.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://product-box-refactor.preview.emergentagent.com').rstrip('/')
