...
Endpoint URL: https://soul-ranked-preview.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://soul-ranked-preview.preview.emergentagent.com').rstrip('/')
