...
Endpoint URL: https://learn-golden-1.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://learn-golden-1.preview.emergentagent.com').rstrip('/')
