...
Endpoint URL: https://mira-concierge-app.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-concierge-app.preview.emergentagent.com').rstrip('/')
