...
Endpoint URL: https://frontend-regression.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://frontend-regression.preview.emergentagent.com').rstrip('/')
