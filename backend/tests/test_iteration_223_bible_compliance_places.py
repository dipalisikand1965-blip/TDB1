...
Endpoint URL: https://doggy-verified.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://doggy-verified.preview.emergentagent.com').rstrip('/')
