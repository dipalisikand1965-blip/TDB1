...
Endpoint URL: https://mira-os-preview-4.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-os-preview-4.preview.emergentagent.com').rstrip('/')
