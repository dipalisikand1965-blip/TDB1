...
Endpoint URL: https://pet-os-live.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-os-live.preview.emergentagent.com').rstrip('/')
