...
Endpoint URL: https://pillar-consistency.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pillar-consistency.preview.emergentagent.com').rstrip('/')
