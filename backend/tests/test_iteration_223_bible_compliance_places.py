...
Endpoint URL: https://dine-intelligence.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://dine-intelligence.preview.emergentagent.com').rstrip('/')
