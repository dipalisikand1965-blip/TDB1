...
Endpoint URL: https://concierge-wiring.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://concierge-wiring.preview.emergentagent.com').rstrip('/')
