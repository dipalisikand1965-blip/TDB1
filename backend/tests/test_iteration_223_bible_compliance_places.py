...
Endpoint URL: https://rainbow-bridge-3.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://rainbow-bridge-3.preview.emergentagent.com').rstrip('/')
