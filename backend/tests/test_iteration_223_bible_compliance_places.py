...
Endpoint URL: https://dine-consistency-fix.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://dine-consistency-fix.preview.emergentagent.com').rstrip('/')
