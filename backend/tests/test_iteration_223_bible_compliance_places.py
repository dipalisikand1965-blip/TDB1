...
Endpoint URL: https://mira-soul-os.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-soul-os.preview.emergentagent.com').rstrip('/')
