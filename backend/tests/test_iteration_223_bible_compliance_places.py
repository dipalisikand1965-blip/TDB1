...
Endpoint URL: https://data-integrity-task.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://data-integrity-task.preview.emergentagent.com').rstrip('/')
