...
Endpoint URL: https://pillar-personalize.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pillar-personalize.preview.emergentagent.com').rstrip('/')
