...
Endpoint URL: https://concierge-unified.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://concierge-unified.preview.emergentagent.com').rstrip('/')
