...
Endpoint URL: https://doggy-ecommerce-test.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://doggy-ecommerce-test.preview.emergentagent.com').rstrip('/')
