...
Endpoint URL: https://mira-soul-sync-1.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-soul-sync-1.preview.emergentagent.com').rstrip('/')
