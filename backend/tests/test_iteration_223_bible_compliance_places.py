...
Endpoint URL: https://doggy-ai-mockups.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://doggy-ai-mockups.preview.emergentagent.com').rstrip('/')
