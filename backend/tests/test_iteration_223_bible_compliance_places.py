...
Endpoint URL: https://pet-home-hub.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-home-hub.preview.emergentagent.com').rstrip('/')
