...
Endpoint URL: https://ai-experience-unify.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://ai-experience-unify.preview.emergentagent.com').rstrip('/')
