...
Endpoint URL: https://mira-parity-sprint.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-parity-sprint.preview.emergentagent.com').rstrip('/')
