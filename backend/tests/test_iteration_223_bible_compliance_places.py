...
Endpoint URL: https://mira-gift-generator.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-gift-generator.preview.emergentagent.com').rstrip('/')
