...
Endpoint URL: https://doggy-platform-2.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://doggy-platform-2.preview.emergentagent.com').rstrip('/')
