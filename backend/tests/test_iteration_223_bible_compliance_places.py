...
Endpoint URL: https://golden-pillar-hub.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://golden-pillar-hub.preview.emergentagent.com').rstrip('/')
