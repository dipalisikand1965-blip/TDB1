...
Endpoint URL: https://pet-intent.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-intent.preview.emergentagent.com').rstrip('/')
