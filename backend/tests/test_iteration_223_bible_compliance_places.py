...
Endpoint URL: https://mira-soul-ai.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-soul-ai.preview.emergentagent.com').rstrip('/')
