...
Endpoint URL: https://mira-dine-proto.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-dine-proto.preview.emergentagent.com').rstrip('/')
