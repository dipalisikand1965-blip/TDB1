...
Endpoint URL: https://mira-pet-os-1.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-pet-os-1.preview.emergentagent.com').rstrip('/')
