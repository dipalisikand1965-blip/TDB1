...
Endpoint URL: https://ai-watercolor.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://ai-watercolor.preview.emergentagent.com').rstrip('/')
