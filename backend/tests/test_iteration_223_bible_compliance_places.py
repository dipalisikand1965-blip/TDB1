...
Endpoint URL: https://mira-bible-v1.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mira-bible-v1.preview.emergentagent.com').rstrip('/')
