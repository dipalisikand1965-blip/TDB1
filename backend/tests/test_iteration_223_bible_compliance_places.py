...
Endpoint URL: https://care-pillar-impl.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://care-pillar-impl.preview.emergentagent.com').rstrip('/')
