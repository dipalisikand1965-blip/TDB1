...
Endpoint URL: https://go-pillar-launch.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://go-pillar-launch.preview.emergentagent.com').rstrip('/')
