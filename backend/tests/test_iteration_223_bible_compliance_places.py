...
Endpoint URL: https://pet-hub-grid.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://pet-hub-grid.preview.emergentagent.com').rstrip('/')
