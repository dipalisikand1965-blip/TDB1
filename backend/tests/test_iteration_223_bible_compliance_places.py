...
Endpoint URL: https://concierge-pillars.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://concierge-pillars.preview.emergentagent.com').rstrip('/')
