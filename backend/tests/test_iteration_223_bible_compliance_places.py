...
Endpoint URL: https://mystique-memorial.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://mystique-memorial.preview.emergentagent.com').rstrip('/')
