    ...
    try:
        ...
        if faq_count == 0:
            ...
            sample_faqs = [
                ...
                {"id": "faq-pulse-1", "question": "What is Pulse ⚡?", "answer": "Pulse is your quick voice assistant - the fast responder that captures what you say, understands your intent (treats, grooming, vet visit), and routes it to Mira for smart handling. Pulse gets things moving quickly!", "category": "Pulse & Mira", "order": 9},
                {"id": "faq-pulse-mira-1", "question": "What's the difference between Pulse and Mira?", "answer": "Pulse ⚡ is speed - fast voice/text capture and routing. Mira 🐕‍🦺 is intelligence - memory, reasoning, and personalized care. They work together: Pulse captures your request instantly, Mira processes it with your pet's full context and history.", "category": "Pulse & Mira", "order": 10},
                {"id": "faq-pulse-mira-2", "question": "How do Pulse and Mira work together?", "answer": "When you speak or type, Pulse captures your intent instantly and routes it to Mira. Mira then uses her knowledge of your pet (preferences, allergies, history) to give you a personalized response. Example: You say 'treats for Mojo' → Pulse captures → Mira remembers Mojo likes chicken, avoids beef → You get perfect recommendations!", "category": "Pulse & Mira", "order": 11},
            ]
    ...
    celebrate_services = [
        {
            ...
            "description": "Complete party planning service for your pet's special day. We handle everything from venue to cake!",
            "pillar": "celebrate",
            "category": "party",
            "price": 4999,
            "duration": "Full Day",
        ...
        },
        {
            ...
            "description": "Studio or outdoor photoshoot with professional pet photographer. Create lasting memories!",
            "pillar": "celebrate",
        ...
        {
            "id": "svc-celebrate-cake-consult",
            "name": "Custom Cake Consultation",
            "description": "One-on-one consultation with our cake designer to create the perfect custom cake.",
            "pillar": "celebrate",
        ...
        {
            "id": "svc-celebrate-pawty-package",
            "name": "Pawty Package (Full Celebration)",
            "description": "The ultimate celebration package - cake, treats, photoshoot, decorations & party coordination!",
            "pillar": "celebrate",
            "category": "premium",
            "price": 9999,
            "duration": "Full Day",
        ...
        },
        {
            ...
            "description": "Celebrate your pet's adoption anniversary with a special gotcha day package.",
            "pillar": "celebrate",
            "category": "gotcha",
            "price": 2499,
            "duration": "Half Day",
        ...
        {
            "id": "svc-celebrate-surprise",
            "name": "Surprise Delivery Service",
            "description": "Send surprise treats and gifts to any pet parent! We deliver joy anywhere.",
            "pillar": "celebrate",
            "category": "surprise",
            "price": 1499,
            "duration": "Same Day",
        ...
        {
            "id": "svc-celebrate-milestone",
            "name": "Milestone Celebration Kit",
            "description": "Celebrate your pet's milestones - first walk, 1 year, 100 treats, weight goals and more!",
            "pillar": "celebrate",
            "category": "milestone",
            "price": 1999,
            "duration": "Delivered",
        ...
        {
            "id": "svc-celebrate-venue",
            "name": "Pet-Friendly Venue Booking",
            "description": "We find and book the perfect pet-friendly venue for your celebration.",
            "pillar": "celebrate",
            "category": "venue",
            "price": 999,
...
async def lifespan(app: FastAPI):
    ...
    async def master_sync_on_startup():
        ...
        try:
            ...
            # The onboarding flow properly sets owner_id and owner_email
            try:
                # Just log orphan pets for monitoring, don't auto-assign them
                orphan_pets = await db.pets.count_documents({"$or": [{"owner_id": None}, {"owner_id": {"$exists": False}}]})
                if orphan_pets > 0:
                    logger.warning(f"[PET LINKING] Found {orphan_pets} orphan pets without owner_id - NOT auto-assigning (by design)")
                ...
                if pets_without_email > 0:
                    logger.warning(f"[PET LINKING] Found {pets_without_email} pets without owner_email - NOT auto-assigning (by design)")
...
async def get_all_products(
    ...
    Uses consolidated products_master collection (single source of truth).
    """
    query = {}
    if category:
    ...
    # Query products_master (single source of truth)
    all_products = await db.products_master.find(query, {"_id": 0}).limit(limit).to_list(limit)
    ...
    pillars = await db.products_master.distinct("primary_pillar")
...
"""
    ...
    ticket = {
        ...
        "subject": f"{service_type} - {pet_name} ({customer_name})",
...
async def get_pet_recommendations(pet_id: str, limit: int = 20, pillar: str = None):
    ...
    for p in products:
        ...
        if breed:
            ...
            # Special bonus for breed products ONLY if matching pillar or no pillar filter
            # Cakes get bonus only on celebrate/dine pillars
            if "cake" in name_lower or category in ["cakes", "breed-cakes"]:
                if not pillar or pillar in ["celebrate", "dine"]:
                    for bw in breed_words:
                        if bw in name_lower:
                            score += 30  # Bonus for breed-specific cakes on celebrate pillar
...
# ==========================================
# PRODUCT IMAGE MIGRATION ENDPOINT
# ==========================================

@api_router.post("/admin/migrate-product-images")
async def migrate_product_images():
    """One-time migration to add AI-generated images to Dine & Care products"""
    ...
    CARE_IMAGES = {
        ...
        "agility": "https://static.prod-images.emergentagent.com/jobs/f8fcb8e7-1e5e-4376-99c7-472b9035c75b/images/bf0b8070dba4aa932bc55709b0920720897bee4bfbac9a6f3e00665327375b2a.png",
        "massage": "https://static.prod-images.emergentagent.com/jobs/f8fcb8e7-1e5e-4376-99c7-472b9035c75b/images/cfbced3ad11570a9d786ef8de3124dd1baffdca5a57c2b5f392609ced6bc1ffe.png",
        "daycare": "https://static.prod-images.emergentagent.com/jobs/f8fcb8e7-1e5e-4376-99c7-472b9035c75b/images/91831145c20a6a1e31a01a41a3488f89dc43cb9c36334bec0733bb2f10e61973.png",
        "wipes": "https://static.prod-images.emergentagent.com/jobs/f8fcb8e7-1e5e-4376-99c7-472b9035c75b/images/59e05141d4a723f0bb45775680866f9c66556176c17e1e9f1cda8da4e84a940f.png",
    }
    
    def get_dine_image(name):
        name_lower = name.lower()
        if 'chicken' in name_lower or 'rice' in name_lower or 'lamb' in name_lower or 'turkey' in name_lower:
            return DINE_IMAGES["fresh_chicken"]
        if 'veggie' in name_lower or 'pumpkin' in name_lower or 'oats' in name_lower or 'senior' in name_lower:
            return DINE_IMAGES["veggie"]
        if 'fish' in name_lower or 'quinoa' in name_lower or 'salmon' in name_lower:
            return DINE_IMAGES["fish"]
        if 'slow feeder' in name_lower or 'puzzle' in name_lower:
            return DINE_IMAGES["slow_feeder"]
        if 'travel' in name_lower or 'collapsible' in name_lower or 'portable' in name_lower:
            return DINE_IMAGES["travel_bowl"]
        if 'water bottle' in name_lower or 'pup cup' in name_lower:
            return DINE_IMAGES["water_bottle"]
        if 'elevated' in name_lower:
            return DINE_IMAGES["elevated_bowl"]
        if 'ceramic' in name_lower or 'personalized' in name_lower:
            return DINE_IMAGES["ceramic_bowl"]
        if 'photo' in name_lower or 'party' in name_lower or 'birthday' in name_lower:
            return DINE_IMAGES["party"]
        return DINE_IMAGES["restaurant"]
    
    def get_care_image(name):
        name_lower = name.lower()
        if 'first aid' in name_lower or 'wound' in name_lower or 'emergency' in name_lower:
            return CARE_IMAGES["first_aid"]
        if 'dental' in name_lower or 'tooth' in name_lower:
            return CARE_IMAGES["dental_kit"]
        if 'brush' in name_lower or 'clipper' in name_lower or 'deshed' in name_lower or 'ear clean' in name_lower:
            return CARE_IMAGES["grooming_tools"]
        if 'shampoo' in name_lower or 'conditioner' in name_lower or 'bath' in name_lower:
            return CARE_IMAGES["spa_kit"]
        if 'calm' in name_lower or 'anxiety' in name_lower or 'stress' in name_lower:
            return CARE_IMAGES["calming"]
        if 'train' in name_lower or 'clicker' in name_lower:
            return CARE_IMAGES["training_kit"]
        if 'harness' in name_lower or 'leash' in name_lower or 'collar' in name_lower:
            return CARE_IMAGES["harness_leash"]
        if 'poop' in name_lower or 'waste' in name_lower or 'bag' in name_lower:
            return CARE_IMAGES["eco_bags"]
        if 'supplement' in name_lower or 'vitamin' in name_lower or 'joint' in name_lower or 'probiotic' in name_lower:
            return CARE_IMAGES["supplements"]
        if 'wellness' in name_lower or 'vet' in name_lower or 'checkup' in name_lower:
            return CARE_IMAGES["vet_wellness"]
        if 'groom' in name_lower or 'spa' in name_lower:
            return CARE_IMAGES["grooming_service"]
        if 'daycare' in name_lower or 'boarding' in name_lower:
            return CARE_IMAGES["daycare"]
        if 'agility' in name_lower or 'fitness' in name_lower:
            return CARE_IMAGES["agility"]
        if 'massage' in name_lower or 'yoga' in name_lower:
            return CARE_IMAGES["massage"]
        if 'wipe' in name_lower:
            return CARE_IMAGES["wipes"]
        return CARE_IMAGES["grooming_tools"]
    
    updated_count = 0
    
    # Get all products without images in Dine and Care pillars
    cursor = db.products_master.find({
        "$and": [
            {"$or": [
    ...
    logger.info(f"[IMAGE MIGRATION] Found {len(products)} products without images")
    ...
    for product in products:
        ...
        if 'dine' in pillars or 'feed' in pillars or category == 'dine':
            image_url = get_dine_image(name)
        else:
            image_url = get_care_image(name)
    ...
    logger.info(f"[IMAGE MIGRATION] Updated {updated_count} products/services with images")
    
    return {
        "success": True,
        "message": f"Migration complete: {updated_count} products/services updated with images",
...
@api_router.post("/admin/products/seed-travel-products")
async def seed_travel_products(
    credentials: HTTPBasicCredentials = Depends(security)
):
    """Seed comprehensive travel products for pet parents"""
    verify_admin(credentials)
    ...
    travel_products = [
        # Travel Carriers
        {
            ...
            "description": "TSA-compliant carrier perfect for cabin travel. Expandable design, mesh ventilation, padded interior. Fits under most airline seats.",
            "price": 2999,
            "original_price": 3499,
            ...
            "intelligent_tags": ["airline_approved", "flight_travel", "cabin_size", "expandable", "small_breed", "medium_breed", "travel_essential"],
            "breed_tags": ["small_breed", "medium_breed"],
            "health_tags": ["anxiety_relief", "comfort"],
            "lifestage_tags": ["all_ages"],
            "size_tags": ["small_breed", "medium_breed"],
            "occasion_tags": ["flight", "travel", "vacation"],
            "cross_sell_products": ["travel-water-bottle", "calming-spray", "travel-bed"],
            "frequently_bought_together": ["pee-pads", "portable-bowl"],
            "suitable_for_breeds": ["Dogs up to 8kg"],
            "not_suitable_for": ["Large breeds"],
            "gst_rate": 18,
            "created_at": get_utc_timestamp()
        },
        {
            "id": f"travel-{uuid.uuid4().hex[:8]}",
            "name": "Premium Car Seat for Dogs",
            "description": "Elevated car seat with safety harness attachment. Plush memory foam, waterproof base. Perfect for road trips.",
            "price": 3499,
            "original_price": 4299,
            ...
            "intelligent_tags": ["car_travel", "elevated_seat", "safety", "crash_tested", "road_trip", "small_breed", "medium_breed"],
            "breed_tags": ["small_breed", "medium_breed"],
            "health_tags": ["joint_support", "comfort", "anxiety_relief"],
            "lifestage_tags": ["all_ages"],
            "size_tags": ["small_breed", "medium_breed"],
            "occasion_tags": ["road_trip", "daily_commute", "vet_visits"],
            "cross_sell_products": ["car-harness", "seat-cover", "travel-water-bottle"],
            "frequently_bought_together": ["car-hammock", "window-shade"],
            "suitable_for_breeds": ["Dogs up to 15kg"],
            "not_suitable_for": ["Large breeds over 15kg"],
            "gst_rate": 18,
            "created_at": get_utc_timestamp()
        },
        # Travel Safety
        {
            "id": f"travel-{uuid.uuid4().hex[:8]}",
            "name": "Crash-Tested Dog Harness",
            "description": "Military-grade harness tested at 3x pet weight. Padded chest plate, quick-release buckle. Essential for car safety.",
            "price": 1899,
            "original_price": 2299,
            "category": "travel-safety",
            "pillar": "travel",
            ...
            "intelligent_tags": ["crash_tested", "car_safety", "military_grade", "all_sizes", "essential"],
            "breed_tags": ["all_breeds"],
            "health_tags": ["safety"],
            "lifestage_tags": ["all_ages"],
            "size_tags": ["small_breed", "medium_breed", "large_breed"],
            "occasion_tags": ["car_travel", "road_trip", "daily"],
            "cross_sell_products": ["seat-belt-clip", "car-seat"],
            "frequently_bought_together": ["car-seat-cover"],
            "suitable_for_breeds": ["All breeds"],
            "not_suitable_for": [],
            "gst_rate": 18,
            "created_at": get_utc_timestamp()
        },
        {
            ...
            "description": "Real-time location tracking with 30-day battery. Geo-fencing alerts, activity monitoring. Peace of mind when traveling.",
            "price": 4999,
            "original_price": 5999,
            ...
            "intelligent_tags": ["gps_tracker", "location", "safety", "tech", "all_sizes", "travel_essential", "vacation"],
            "breed_tags": ["all_breeds"],
            "health_tags": ["safety", "peace_of_mind"],
            "lifestage_tags": ["all_ages"],
            "size_tags": ["small_breed", "medium_breed", "large_breed"],
            "occasion_tags": ["travel", "vacation", "daily", "outdoor"],
            "cross_sell_products": ["extra-collar", "charging-dock"],
            "frequently_bought_together": ["id-tag", "leash"],
            "suitable_for_breeds": ["All breeds"],
            "not_suitable_for": [],
            "gst_rate": 18,
            "created_at": get_utc_timestamp()
        ...
        {
            "id": f"travel-{uuid.uuid4().hex[:8]}",
            "name": "Motion Sickness Relief Kit",
            "description": "Natural ginger-based tablets + calming spray combo. Veterinarian recommended for car/air travel. Safe for all breeds.",
            "price": 799,
            "original_price": 999,
            ...
            "intelligent_tags": ["motion_sickness", "calming", "natural", "vet_recommended", "all_sizes", "travel_essential"],
            "breed_tags": ["all_breeds"],
            "health_tags": ["motion_sickness", "nausea", "anxiety", "stomach"],
            "lifestage_tags": ["adult", "senior"],
            "size_tags": ["all_sizes"],
            "occasion_tags": ["car_travel", "flight", "road_trip"],
            "cross_sell_products": ["calming-chews", "portable-water-bowl"],
            "frequently_bought_together": ["pee-pads", "cleaning-wipes"],
            "suitable_for_breeds": ["All breeds"],
            "not_suitable_for": ["Puppies under 3 months"],
            "gst_rate": 12,
            "created_at": get_utc_timestamp()
        },
        {
            ...
            "description": "Compact emergency kit with bandages, antiseptic, tick remover, emergency blanket. Essential for road trips and hikes.",
            "price": 1299,
            "original_price": 1599,
            "category": "travel-health",
            "pillar": "travel",
            ...
            "intelligent_tags": ["first_aid", "emergency", "safety", "outdoor", "hiking", "road_trip", "essential"],
            "breed_tags": ["all_breeds"],
            "health_tags": ["emergency", "first_aid", "wound_care"],
            "lifestage_tags": ["all_ages"],
            "size_tags": ["all_sizes"],
            "occasion_tags": ["travel", "outdoor", "hiking", "camping", "road_trip"],
            "cross_sell_products": ["tick-spray", "paw-balm"],
            "frequently_bought_together": ["water-bottle", "travel-bowl"],
            "suitable_for_breeds": ["All breeds"],
            "not_suitable_for": [],
            "gst_rate": 12,
            "created_at": get_utc_timestamp()
        ...
        {
            "id": f"travel-{uuid.uuid4().hex[:8]}",
            "name": "Collapsible Travel Bowl Set (2-pack)",
            "description": "Silicone bowls with carabiner clips. Food-grade, dishwasher safe. One for food, one for water. Perfect for on-the-go.",
            "price": 599,
            "original_price": 799,
            ...
            "intelligent_tags": ["collapsible", "portable", "food_grade", "travel_essential", "budget_friendly", "all_sizes"],
            "breed_tags": ["all_breeds"],
            "health_tags": ["hydration", "feeding"],
            "lifestage_tags": ["all_ages"],
            "size_tags": ["all_sizes"],
            "occasion_tags": ["travel", "hiking", "outdoor", "daily"],
            "cross_sell_products": ["water-bottle", "treat-pouch"],
            "frequently_bought_together": ["travel-bag", "leash"],
            "suitable_for_breeds": ["All breeds"],
            "not_suitable_for": [],
            "gst_rate": 18,
            "created_at": get_utc_timestamp()
        },
        {
            ...
            "description": "350ml water bottle with attached bowl dispenser. One-hand operation, leak-proof. Perfect for walks and travel.",
            "price": 449,
            "original_price": 599,
            "category": "travel-accessories",
            "pillar": "travel",
            ...
            "intelligent_tags": ["water_bottle", "portable", "hydration", "leak_proof", "budget_friendly", "travel_essential"],
            "breed_tags": ["all_breeds"],
            "health_tags": ["hydration"],
            "lifestage_tags": ["all_ages"],
            "size_tags": ["all_sizes"],
            "occasion_tags": ["travel", "walks", "hiking", "outdoor", "daily"],
            "cross_sell_products": ["collapsible-bowl", "treat-pouch"],
            "frequently_bought_together": ["poop-bags", "leash"],
            "suitable_for_breeds": ["All breeds"],
            "not_suitable_for": [],
            "gst_rate": 18,
            "created_at": get_utc_timestamp()
        ...
        {
            "id": f"travel-{uuid.uuid4().hex[:8]}",
            "name": "Pet Travel Bag Organizer",
            "description": "Multi-pocket bag for all pet essentials. Fits food, treats, bowls, toys, documents. Waterproof base, shoulder strap.",
            "price": 1499,
            "original_price": 1999,
            "category": "travel-accessories",
            "pillar": "travel",
            ...
            "intelligent_tags": ["travel_bag", "organizer", "multi_pocket", "waterproof", "travel_essential"],
            "breed_tags": ["all_breeds"],
            "health_tags": [],
            "lifestage_tags": ["all_ages"],
            "size_tags": ["all_sizes"],
            "occasion_tags": ["travel", "vacation", "road_trip", "weekend"],
            "cross_sell_products": ["travel-bowls", "first-aid-kit", "poop-bag-dispenser"],
            "frequently_bought_together": ["treat-pouch", "pee-pads"],
            "suitable_for_breeds": ["All breeds"],
            "not_suitable_for": [],
            "gst_rate": 18,
            "created_at": get_utc_timestamp()
        ...
        # Travel Comfort
        {
            ...
            "description": "Foldable memory foam bed with waterproof cover. Sets up in seconds. Provides familiar comfort away from home.",
            "price": 1999,
            "original_price": 2499,
            ...
            "intelligent_tags": ["travel_bed", "foldable", "memory_foam", "waterproof", "comfort", "anxiety_relief"],
            "breed_tags": ["all_breeds"],
            "health_tags": ["joint_support", "comfort", "anxiety_relief"],
            "lifestage_tags": ["all_ages"],
            "size_tags": ["small_breed", "medium_breed"],
            "occasion_tags": ["travel", "vacation", "hotel_stay", "camping"],
            "cross_sell_products": ["calming-spray", "travel-blanket"],
            "frequently_bought_together": ["familiar-toy", "calming-chews"],
            "suitable_for_breeds": ["Dogs up to 20kg"],
            "not_suitable_for": ["Giant breeds"],
            "gst_rate": 18,
            "created_at": get_utc_timestamp()
        },
        {
            "id": f"travel-{uuid.uuid4().hex[:8]}",
            "name": "Calming Travel Spray",
            "description": "Pheromone-based spray for carriers, cars, hotel rooms. Reduces travel anxiety naturally. Vet recommended.",
            "price": 699,
            "original_price": 899,
            "category": "travel-health",
            "pillar": "travel",
            ...
            "intelligent_tags": ["calming", "anxiety_relief", "pheromone", "natural", "vet_recommended", "travel_essential"],
            "breed_tags": ["all_breeds"],
...
class PartyRequestModel(BaseModel):
    ...
    includeGrooming: bool = False
    includePhotography: bool = False
    includeVenue: bool = False
...
async def create_party_request(request: PartyRequestModel):
    ...
    party_request = {
        ...
        "add_ons": {
            "grooming": request.includeGrooming,
            "photography": request.includePhotography,
            "venue_booking": request.includeVenue
        },
        "user_email": request.user_email,
        "user_name": request.user_name,
        "status": "pending",
...
async def get_party_requests(
    ...
    requests = await db.party_requests.find(query, {"_id": 0}).sort("created_at", -1).limit(limit).to_list(limit)
...
async def generate_report(
    ...
    if report_type == "daily_summary":
        ...
        return {
            ...
            "rows": []  # Would populate with daily breakdowns
        }
        ...
        rows = []
        for o in orders[:100]:  # Limit for preview
            rows.append([
        ...
        # Filter by date for new members
