...
async def create_party_request(request: PartyRequestModel):
    ...
    logger.info(f"✨ Created party request {request_id} with ticket {ticket_id}")
    
    return {
        "success": True,
        "request_id": request_id,
        "ticket_id": ticket_id,
        "message": f"Party planning request created! Our Celebrate Concierge® will contact you soon."
    }
