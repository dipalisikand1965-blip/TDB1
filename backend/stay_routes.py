...
async def seed_stay_products(username: str = Depends(verify_admin)):
    ...
    default_products = [
        # Travel Carriers & Bags
        {
            "id": "stay-prod-carrier-airline",
            "name": "Airline-Approved Pet Carrier",
            "description": "TSA and IATA approved soft-sided carrier with mesh ventilation, fleece bedding, and multiple access points.",
            "price": 2999,
            "original_price": 3599,
            "image": "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600",
            "category": "travel-carrier",
            "tags": ["carrier", "airline", "travel", "iata"],
            "stock": 50,
            "paw_reward_points": 30,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-carrier-backpack",
            "name": "Ventilated Pet Backpack Carrier",
            "description": "Expandable backpack carrier with bubble window, ventilation holes, and padded straps.",
            "price": 2499,
            "original_price": 2999,
            "image": "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=600",
            "category": "travel-carrier",
            "tags": ["carrier", "backpack", "hiking", "adventure"],
            "stock": 40,
            "paw_reward_points": 25,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-carrier-wheeled",
            "name": "Wheeled Pet Carrier Trolley",
            "description": "Rolling carrier with telescopic handle, perfect for airports and train stations.",
            "price": 3499,
            "original_price": 4199,
            "image": "https://images.unsplash.com/photo-1507146426996-ef05306b995a?w=600",
            "category": "travel-carrier",
            "tags": ["carrier", "wheeled", "trolley", "airport"],
            "stock": 30,
        ...
        {
            "id": "stay-prod-bowl-collapsible",
            "name": "Collapsible Silicone Bowl Set",
            "description": "Food and water bowls that collapse flat - includes 2 bowls with carabiner clips.",
            "price": 499,
            "original_price": 649,
            "image": "https://images.unsplash.com/photo-1601758124096-1fd661873db9?w=600",
            "category": "travel-feeding",
            "tags": ["bowl", "collapsible", "silicone", "portable"],
            "stock": 100,
            "paw_reward_points": 5,
            "pillar": "stay"
        },
        {
            ...
            "name": "2-in-1 Water Bottle & Bowl",
            "description": "Leak-proof water bottle with flip-out drinking tray - 500ml capacity.",
            "price": 699,
            "original_price": 849,
            "image": "https://images.unsplash.com/photo-1530281700549-e82e7bf110d6?w=600",
            "category": "travel-feeding",
            "tags": ["water", "bottle", "portable", "bowl"],
            "stock": 90,
            "paw_reward_points": 7,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-travel-food-container",
            "name": "Airtight Travel Food Container",
            "description": "3-compartment container for food, treats, and supplements - leak-proof design.",
            "price": 899,
            "original_price": 1099,
            "image": "https://images.unsplash.com/photo-1535930891776-0c2dfb7fda1a?w=600",
            "category": "travel-feeding",
            "tags": ["container", "food", "airtight", "storage"],
            "stock": 70,
            "paw_reward_points": 9,
            "pillar": "stay"
        },
        
        # Travel Bedding & Comfort
        {
            "id": "stay-prod-bed-portable",
            "name": "Portable Memory Foam Travel Bed",
            "description": "Lightweight, foldable bed with removable, washable cover - rolls up for easy packing.",
            "price": 1799,
            "original_price": 2199,
            "image": "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=600",
            "category": "travel-comfort",
            "tags": ["bed", "portable", "memory-foam", "foldable"],
            "stock": 35,
            "paw_reward_points": 18,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-blanket-travel",
            "name": "Waterproof Travel Blanket",
            "description": "Soft fleece blanket with waterproof backing - protects hotel beds and car seats.",
            "price": 999,
            "original_price": 1249,
            "image": "https://images.unsplash.com/photo-1518882605630-8307abd49bcc?w=600",
            "category": "travel-comfort",
            "tags": ["blanket", "waterproof", "fleece", "protection"],
            "stock": 60,
            "paw_reward_points": 10,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-cooling-mat",
            "name": "Pressure-Activated Cooling Mat",
            "description": "Self-cooling gel mat for hot weather travel - no refrigeration needed.",
            "price": 1299,
            "original_price": 1599,
            "image": "https://images.unsplash.com/photo-1544568100-847a948585b9?w=600",
            "category": "travel-comfort",
            "tags": ["cooling", "mat", "summer", "gel"],
            "stock": 45,
        ...
        # Safety & Restraints
        {
            "id": "stay-prod-car-harness",
            "name": "Crash-Tested Car Safety Harness",
            "description": "Vehicle safety harness tested to 3x pet weight with padded chest plate.",
            "price": 1699,
            "original_price": 1999,
            "image": "https://images.unsplash.com/photo-1534361960057-19889db9621e?w=600",
            ...
            "stock": 55,
            "paw_reward_points": 17,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-car-seat",
            "name": "Elevated Pet Car Seat",
            "description": "Booster seat with safety tether - lets small pets see out the window safely.",
            "price": 2299,
            "original_price": 2799,
            "image": "https://images.unsplash.com/photo-1541364983171-a8ba01e95cfc?w=600",
            "category": "travel-safety",
            "tags": ["car-seat", "booster", "safety", "small-pets"],
            "stock": 30,
            "paw_reward_points": 23,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-gps-tracker",
            "name": "GPS Pet Tracker Collar",
            "description": "Real-time GPS tracking with activity monitoring and geo-fencing alerts.",
            "price": 3999,
            "original_price": 4799,
            "image": "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600",
            "category": "travel-safety",
            "tags": ["gps", "tracker", "collar", "safety"],
            "stock": 40,
        ...
        # Calming & Anxiety
        {
            "id": "stay-prod-anxiety-kit",
            "name": "Travel Anxiety Relief Kit",
            "description": "Complete kit: calming treats, pheromone spray, anxiety wrap, and lavender sachets.",
            "price": 1499,
            "original_price": 1799,
            "image": "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=600",
            "category": "travel-calming",
            "tags": ["anxiety", "calming", "kit", "travel"],
            "stock": 50,
            "paw_reward_points": 15,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-calming-spray",
            "name": "Calming Pheromone Spray",
            "description": "Spray on carrier or bedding to reduce travel stress - 60ml bottle.",
            "price": 599,
            "original_price": 749,
            "image": "https://images.unsplash.com/photo-1507146426996-ef05306b995a?w=600",
            "category": "travel-calming",
            "tags": ["pheromone", "spray", "calming", "stress"],
            "stock": 80,
            "paw_reward_points": 6,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-calming-treats",
            "name": "Travel Calming Chews",
            "description": "Soft chews with chamomile, valerian & L-theanine - 30 count.",
            "price": 799,
            "original_price": 999,
            "image": "https://images.unsplash.com/photo-1535930891776-0c2dfb7fda1a?w=600",
            "category": "travel-calming",
            "tags": ["treats", "calming", "chews", "natural"],
            "stock": 90,
            "paw_reward_points": 8,
            "pillar": "stay"
        },
        ...
        # First Aid & Health
        {
            "id": "stay-prod-firstaid-kit",
            "name": "Pet Travel First Aid Kit",
            "description": "Comprehensive kit: bandages, antiseptic, tick remover, emergency contacts card.",
            "price": 999,
            "original_price": 1199,
            "image": "https://images.unsplash.com/photo-1541364983171-a8ba01e95cfc?w=600",
        ...
        {
            "id": "stay-prod-motion-sickness",
            "name": "Motion Sickness Relief Tablets",
            "description": "Natural anti-nausea tablets for car and air travel - 30 tablets.",
            "price": 599,
            "original_price": 749,
            "image": "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600",
            "category": "travel-health",
            "tags": ["motion-sickness", "nausea", "tablets", "car"],
            "stock": 75,
            "paw_reward_points": 6,
            "pillar": "stay"
        },
        ...
        # Documentation & ID
        {
            "id": "stay-prod-pet-passport",
            "name": "Pet Travel Document Organizer",
            "description": "Waterproof organizer for vaccination records, health certificates, and ID.",
            "price": 699,
            "original_price": 849,
            "image": "https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=600",
            "category": "travel-docs",
            "tags": ["documents", "organizer", "passport", "records"],
            "stock": 80,
            "paw_reward_points": 7,
            "pillar": "stay"
        },
        {
            "id": "stay-prod-id-tags",
            "name": "Engraved Travel ID Tag Set",
            "description": "Set of 2 durable metal tags with name, phone & destination info.",
            "price": 399,
            "original_price": 499,
            "image": "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=600",
            "category": "travel-docs",
            "tags": ["id", "tags", "engraved", "safety"],
            "stock": 100,
            "paw_reward_points": 4,
            "pillar": "stay"
        },
