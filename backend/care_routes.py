...
async def seed_care_products():
    ...
    default_products = [
        # Grooming Products
        {
            ...
            "price": 899,
            "compare_price": 1299,
            "image": CARE_IMAGES["grooming_tools"],
            "images": [CARE_IMAGES["grooming_tools"]],
            "category": "care",
            "care_type": "grooming",
            "subcategory": "brush",
        ...
        },
        {
            ...
            "price": 449,
            "compare_price": 599,
            "image": CARE_IMAGES["spa_kit"],
            "images": [CARE_IMAGES["spa_kit"]],
            "category": "care",
            "care_type": "grooming",
            "subcategory": "shampoo",
        ...
        # Walking Products
        {
            ...
            "price": 599,
            "compare_price": 799,
            "image": CARE_IMAGES["harness_leash"],
            "images": [CARE_IMAGES["harness_leash"]],
            "category": "care",
            "care_type": "walks",
            "subcategory": "leash",
        ...
        },
        {
            ...
            "price": 299,
            "compare_price": 399,
            "image": CARE_IMAGES["eco_bags"],
            "images": [CARE_IMAGES["eco_bags"]],
            "category": "care",
            "care_type": "walks",
        ...
        # Training Products
        {
            ...
            "price": 549,
            "compare_price": 699,
            "image": CARE_IMAGES["training_kit"],
            "images": [CARE_IMAGES["training_kit"]],
            "category": "care",
            "care_type": "training",
            "subcategory": "treats",
        ...
        # Wellness Products
        {
            ...
            "price": 699,
            "compare_price": 899,
            "image": CARE_IMAGES["calming"],
            "images": [CARE_IMAGES["calming"]],
            "category": "care",
            "care_type": "wellness",
            "subcategory": "calming",
        ...
        },
        {
            ...
            "price": 599,
            "compare_price": 799,
            "image": CARE_IMAGES["dental_kit"],
            "images": [CARE_IMAGES["dental_kit"]],
            "category": "care",
            "care_type": "wellness",
            "subcategory": "dental",
        ...
        },
        {
            ...
            "price": 999,
            "compare_price": 1299,
            "image": CARE_IMAGES["first_aid"],
            "images": [CARE_IMAGES["first_aid"]],
            "category": "care",
            "care_type": "wellness",
    ...
    default_bundles = [
        ...
        {
            "id": "care-bundle-dental",
            "bundle_type": "care",
            "name": "Dental Care Bundle",
            "description": "Complete dental health: toothbrush, dental chews, and fresh breath spray.",
            "price": 999,
            "original_price": 1197,
            "image": "https://images.unsplash.com/photo-1587764379873-97837921fd44?w=600",
            "care_type": "dental",
            "items": ["care-toothbrush", "care-dental-chews", "care-breath-spray"],
            "is_recommended": True,
            "paw_reward_points": 15,
            "is_birthday_perk": False
        },
        {
            "id": "care-bundle-spa-day",
            "bundle_type": "care",
            "name": "Spa Day Experience",
            "description": "Pamper your pet: premium shampoo, conditioner, paw balm, and massage brush.",
            "price": 1499,
            "original_price": 1796,
            "image": "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=600",
            "care_type": "grooming",
            "items": ["care-shampoo-premium", "care-conditioner", "care-paw-balm", "care-massage-brush"],
            "is_recommended": True,
            "paw_reward_points": 20,
            "is_birthday_perk": True,
            "birthday_discount_percent": 20
        ...
        {
            "id": "care-bundle-senior",
            "bundle_type": "care",
            "name": "Senior Pet Care Kit",
            "description": "Gentle care for senior pets: joint supplement, soft brush, and calming treats.",
            "price": 1799,
            "original_price": 2096,
            "image": "https://images.unsplash.com/photo-1534361960057-19889db9621e?w=600",
            "care_type": "wellness",
            "items": ["care-joint-supplement", "care-soft-brush", "care-calming-treats"],
            "is_recommended": True,
            "paw_reward_points": 25,
            "is_birthday_perk": False
        }
