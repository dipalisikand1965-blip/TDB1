...
**Preview:** https://soul-os-preview.preview.emergentagent.com
...
```bash
# Weather API
curl "https://soul-os-preview.preview.emergentagent.com/api/test/weather?lat=12.9716&lng=77.5946"

# YouTube API
curl "https://soul-os-preview.preview.emergentagent.com/api/test/youtube?query=dog+grooming"

# Location suggestions for Care
curl "https://soul-os-preview.preview.emergentagent.com/api/mira/location-suggestions/care" \
