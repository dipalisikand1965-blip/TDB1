...
curl -s -u "aditya:lola4304" "https://pet-concierge-qa.preview.emergentagent.com/api/admin/notifications?limit=5"

# Test ticket enrichment
curl -s -X POST "https://pet-concierge-qa.preview.emergentagent.com/api/service_desk/resolve_ticket/TCK-XXX"

# Check pet soul data
curl -s "https://pet-concierge-qa.preview.emergentagent.com/api/pets/pet-3661ae55d2e2"
```
