...
## Frontend
- **Base URL**: https://pet-life-ai.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://pet-life-ai.preview.emergentagent.com/api
...
curl -s -X POST "https://pet-life-ai.preview.emergentagent.com/api/membership/onboard" \
