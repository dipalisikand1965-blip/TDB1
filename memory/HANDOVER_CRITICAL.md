...
## Frontend
- **Base URL**: https://pet-os-auth-fix.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://pet-os-auth-fix.preview.emergentagent.com/api
...
curl -s -X POST "https://pet-os-auth-fix.preview.emergentagent.com/api/membership/onboard" \
