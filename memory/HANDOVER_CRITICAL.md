...
## Frontend
- **Base URL**: https://paw-concierge.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://paw-concierge.preview.emergentagent.com/api
...
curl -s -X POST "https://paw-concierge.preview.emergentagent.com/api/membership/onboard" \
