...
## Frontend
- **Base URL**: https://mira-soul-ai.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://mira-soul-ai.preview.emergentagent.com/api
...
curl -s -X POST "https://mira-soul-ai.preview.emergentagent.com/api/membership/onboard" \
