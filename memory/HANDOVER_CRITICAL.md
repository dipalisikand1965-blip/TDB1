...
## Frontend
- **Base URL**: https://mira-picks.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://mira-picks.preview.emergentagent.com/api
...
curl -s -X POST "https://mira-picks.preview.emergentagent.com/api/membership/onboard" \
