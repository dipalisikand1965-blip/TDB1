...
## Frontend
- **Base URL**: https://dine-intelligence.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://dine-intelligence.preview.emergentagent.com/api
...
curl -s -X POST "https://dine-intelligence.preview.emergentagent.com/api/membership/onboard" \
