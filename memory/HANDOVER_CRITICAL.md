...
## Frontend
- **Base URL**: https://mira-soul-os.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://mira-soul-os.preview.emergentagent.com/api
...
curl -s -X POST "https://mira-soul-os.preview.emergentagent.com/api/membership/onboard" \
