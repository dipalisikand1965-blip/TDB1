...
## Frontend
- **Base URL**: https://pet-concierge-ai.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://pet-concierge-ai.preview.emergentagent.com/api
...
curl -s -X POST "https://pet-concierge-ai.preview.emergentagent.com/api/membership/onboard" \
