...
## Frontend
- **Base URL**: https://frontend-regression.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://frontend-regression.preview.emergentagent.com/api
...
curl -s -X POST "https://frontend-regression.preview.emergentagent.com/api/membership/onboard" \
