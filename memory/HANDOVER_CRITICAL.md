...
## Frontend
- **Base URL**: https://pet-memory-hub.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://pet-memory-hub.preview.emergentagent.com/api
...
curl -s -X POST "https://pet-memory-hub.preview.emergentagent.com/api/membership/onboard" \
