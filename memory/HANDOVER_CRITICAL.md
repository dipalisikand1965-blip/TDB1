...
## Frontend
- **Base URL**: https://pet-ai-brain.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://pet-ai-brain.preview.emergentagent.com/api
...
curl -s -X POST "https://pet-ai-brain.preview.emergentagent.com/api/membership/onboard" \
