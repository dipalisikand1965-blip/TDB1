...
## Frontend
- **Base URL**: https://concierge-pet-os.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://concierge-pet-os.preview.emergentagent.com/api
...
curl -s -X POST "https://concierge-pet-os.preview.emergentagent.com/api/membership/onboard" \
