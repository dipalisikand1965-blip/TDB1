...
## Frontend
- **Base URL**: https://mira-learn-fix.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://mira-learn-fix.preview.emergentagent.com/api
...
curl -s -X POST "https://mira-learn-fix.preview.emergentagent.com/api/membership/onboard" \
