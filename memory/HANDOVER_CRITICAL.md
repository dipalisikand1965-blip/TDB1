...
## Frontend
- **Base URL**: https://soul-aware-picks.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://soul-aware-picks.preview.emergentagent.com/api
...
curl -s -X POST "https://soul-aware-picks.preview.emergentagent.com/api/membership/onboard" \
