...
## Frontend
- **Base URL**: https://mira-concierge-app.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://mira-concierge-app.preview.emergentagent.com/api
...
curl -s -X POST "https://mira-concierge-app.preview.emergentagent.com/api/membership/onboard" \
