...
## Frontend
- **Base URL**: https://doggy-verified.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://doggy-verified.preview.emergentagent.com/api
...
curl -s -X POST "https://doggy-verified.preview.emergentagent.com/api/membership/onboard" \
