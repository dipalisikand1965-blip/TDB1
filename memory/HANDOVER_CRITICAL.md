...
## Frontend
- **Base URL**: https://concierge-lab.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://concierge-lab.preview.emergentagent.com/api
...
curl -s -X POST "https://concierge-lab.preview.emergentagent.com/api/membership/onboard" \
