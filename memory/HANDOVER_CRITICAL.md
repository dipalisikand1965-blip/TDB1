...
## Frontend
- **Base URL**: https://mira-personal-pet.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://mira-personal-pet.preview.emergentagent.com/api
...
curl -s -X POST "https://mira-personal-pet.preview.emergentagent.com/api/membership/onboard" \
