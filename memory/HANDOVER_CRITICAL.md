...
## Frontend
- **Base URL**: https://mira-preview.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://mira-preview.preview.emergentagent.com/api
...
curl -s -X POST "https://mira-preview.preview.emergentagent.com/api/membership/onboard" \
