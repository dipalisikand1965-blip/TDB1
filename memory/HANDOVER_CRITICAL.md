...
## Frontend
- **Base URL**: https://soul-os-preview.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://soul-os-preview.preview.emergentagent.com/api
...
curl -s -X POST "https://soul-os-preview.preview.emergentagent.com/api/membership/onboard" \
