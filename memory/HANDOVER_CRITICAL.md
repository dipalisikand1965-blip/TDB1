...
## Frontend
- **Base URL**: https://soul-picks-engine.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://soul-picks-engine.preview.emergentagent.com/api
...
curl -s -X POST "https://soul-picks-engine.preview.emergentagent.com/api/membership/onboard" \
