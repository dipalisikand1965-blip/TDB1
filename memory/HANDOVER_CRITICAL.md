...
## Frontend
- **Base URL**: https://soul-groom.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://soul-groom.preview.emergentagent.com/api
...
curl -s -X POST "https://soul-groom.preview.emergentagent.com/api/membership/onboard" \
