...
## Frontend
- **Base URL**: https://pet-parent-signup.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://pet-parent-signup.preview.emergentagent.com/api
...
curl -s -X POST "https://pet-parent-signup.preview.emergentagent.com/api/membership/onboard" \
