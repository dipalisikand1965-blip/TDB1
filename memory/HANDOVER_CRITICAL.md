...
## Frontend
- **Base URL**: https://soul-concierge.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://soul-concierge.preview.emergentagent.com/api
...
curl -s -X POST "https://soul-concierge.preview.emergentagent.com/api/membership/onboard" \
