...
## Frontend
- **Base URL**: https://concierge-pillars-1.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://concierge-pillars-1.preview.emergentagent.com/api
...
curl -s -X POST "https://concierge-pillars-1.preview.emergentagent.com/api/membership/onboard" \
