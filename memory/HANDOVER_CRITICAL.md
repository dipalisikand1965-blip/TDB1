...
## Frontend
- **Base URL**: https://mira-legacy.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://mira-legacy.preview.emergentagent.com/api
...
curl -s -X POST "https://mira-legacy.preview.emergentagent.com/api/membership/onboard" \
