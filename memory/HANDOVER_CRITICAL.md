...
## Frontend
- **Base URL**: https://pillar-consistency.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://pillar-consistency.preview.emergentagent.com/api
...
curl -s -X POST "https://pillar-consistency.preview.emergentagent.com/api/membership/onboard" \
