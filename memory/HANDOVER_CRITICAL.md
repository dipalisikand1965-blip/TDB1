...
## Frontend
- **Base URL**: https://concierge-core.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://concierge-core.preview.emergentagent.com/api
...
curl -s -X POST "https://concierge-core.preview.emergentagent.com/api/membership/onboard" \
