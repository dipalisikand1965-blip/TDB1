...
## Frontend
- **Base URL**: https://concierge-pet-magic.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://concierge-pet-magic.preview.emergentagent.com/api
...
curl -s -X POST "https://concierge-pet-magic.preview.emergentagent.com/api/membership/onboard" \
