...
## Frontend
- **Base URL**: https://play-breed-tips.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://play-breed-tips.preview.emergentagent.com/api
...
curl -s -X POST "https://play-breed-tips.preview.emergentagent.com/api/membership/onboard" \
