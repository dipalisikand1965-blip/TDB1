...
## Frontend
- **Base URL**: https://mira-soul-mate.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://mira-soul-mate.preview.emergentagent.com/api
...
curl -s -X POST "https://mira-soul-mate.preview.emergentagent.com/api/membership/onboard" \
