...
## Frontend
- **Base URL**: https://pet-os-flow.preview.emergentagent.com
- **Login**: /login
...
## Backend API
- **Base**: https://pet-os-flow.preview.emergentagent.com/api
...
curl -s -X POST "https://pet-os-flow.preview.emergentagent.com/api/membership/onboard" \
