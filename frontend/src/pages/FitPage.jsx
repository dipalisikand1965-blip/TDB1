      ...
      {(products.length > 0 || bundles.length > 0) && (
        <div id="fit-products" className="py-12 bg-gradient-to-b from-teal-50 to-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            {products.length > 0 && (
              <div>
                <h3 className="text-lg font-semibold text-gray-700 mb-4">🏋️ Fitness Products</h3>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {products.slice(0, 8).map((product) => (
                    <Card key={product.id} className="p-4 hover:shadow-md transition-all">
                      <div className="aspect-square bg-gradient-to-br from-teal-100 to-emerald-50 rounded-lg mb-3 flex items-center justify-center">
                        <Dumbbell className="w-12 h-12 text-teal-300" />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {product.paw_reward_points > 0 && (
                          <span className="text-xs text-teal-600">🐾 {product.paw_reward_points}</span>
                        )}
                      </div>
                    </Card>
                  ))}
