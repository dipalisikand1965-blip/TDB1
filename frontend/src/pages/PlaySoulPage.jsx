        ...
        <div style={{ display:"flex", gap:14, overflowX:"auto", paddingBottom:10, scrollbarWidth:"thin" }} className="play-picks-scroll">
          ...
          {picks.map((pick,i) => {
            ...
            const displayScore = pick._miraRank !== undefined
              ...
              : (pick.mira_score||0);
            const scoreColor = displayScore>=80?"#16A34A":displayScore>=70?G.green:"#6B7280";
            return (
              <div key={pick.id||i}
                ...
                <div style={{ padding:"10px 11px 12px" }}>
                  ...
                  {!isService && <div style={{ display:"flex", alignItems:"center", gap:5, marginBottom:5 }}>
                    <div style={{ flex:1, height:4, background:G.pale, borderRadius:4, overflow:"hidden" }}><div style={{ width:`${displayScore}%`, height:"100%", background:scoreColor, borderRadius:4 }} /></div>
          ...
          <div onClick={e=>e.stopPropagation()} style={{ width:"min(420px,100%)", borderRadius:20, background:"#fff", boxShadow:"0 20px 60px rgba(0,0,0,0.3)", overflow:"hidden" }}>
            <div style={{ background:`linear-gradient(135deg,${G.deep},${G.mid})`, padding:"20px 24px" }}>
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:8 }}>
                <span style={{ fontSize:10, fontWeight:700, background:G.green, color:G.deep, borderRadius:20, padding:"3px 10px" }}>SERVICE</span>
                      ...
                      <div key={q.question_id} style={{ borderRadius:16, padding:14, background:`linear-gradient(135deg,${G.deep},${G.mid})`, border:`1.5px solid ${G.greenBorder}`, minHeight:140 }}>
                                ...
                                return (
                                  <button key={opt}
                                    ...
                                    style={{
                                      ...
                                      background: isSelected ? "#E76F51" : "rgba(255,255,255,0.12)",
                                      border: isSelected ? "2px solid #fff" : "1px solid rgba(255,255,255,0.25)",
                                      color: isSelected ? "#fff" : "rgba(255,255,255,0.80)",
                                      cursor:"pointer",
                                      boxShadow: isSelected ? "0 2px 8px rgba(231,111,81,0.5)" : "none",
                        ...
                        <button onClick={(e) => { e.stopPropagation(); handleSubmit(q); }} disabled={isSend||!hasAns}
                          style={{ marginTop:8, width:"100%", borderRadius:10, padding:10, fontSize:12, fontWeight:800, color:"#fff", display:"flex", alignItems:"center", justifyContent:"center", gap:6,
                            background: !hasAns ? "rgba(255,255,255,0.15)" : "linear-gradient(135deg,#E76F51,#C44400)",
                            border: "none",
                            cursor: isSend ? "wait" : !hasAns ? "not-allowed" : "pointer",
                            opacity: !hasAns ? 0.5 : 1,
                            transition:"all 0.2s ease",
                            boxShadow: hasAns ? "0 2px 12px rgba(231,111,81,0.4)" : "none",
                          }}>
