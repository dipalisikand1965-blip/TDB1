          ...
          {step === 2 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <Card className="p-6 md:p-8 max-w-xl mx-auto">
                ...
                {/* Add another dog button for single pet view */}
                {petsData.length === 1 && (
                  <button
                    onClick={addPet}
                    className="w-full mt-4 p-3 rounded-xl border-2 border-dashed border-purple-300 text-purple-600 hover:bg-purple-50 flex items-center justify-center gap-2"
                  >
