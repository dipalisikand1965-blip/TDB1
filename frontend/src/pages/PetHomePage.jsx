 ...
 * A pet-first, emotion-first experience that dynamically updates
 * as Mira learns more about the pet.
 * 
 * Features:
 * - Pet Hero (photo, name, breed, soul ring, 3 traits)
 * - "What would you like to do for {Pet}?" + pillar shortcuts
 * - Picks for {Pet} button
      ...
      try {
        ...
        if (petsRes.ok) {
          ...
          if (petsData.length > 0) {
            ...
            const soulAnswers = primaryPet.doggy_soul_answers || {};
            ...
            setSoulScore(calculatedScore || 30);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-purple-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-400">Loading {pet?.name || 'your pet'}'s home...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-purple-950">
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="relative p-2 rounded-full bg-slate-800"
            >
          ...
          <div className="relative bg-slate-800/50 rounded-3xl border border-slate-700 p-6">
            ...
            {soulScore < 50 && (
              <button
                ...
                className="mt-4 w-full py-2 bg-gradient-to-r from-pink-500/20 to-purple-600/20 border border-pink-500/30 rounded-xl text-pink-400 text-sm font-medium flex items-center justify-center gap-2"
              >
      ...
      <motion.button
        ...
        className="mx-6 mb-6 w-[calc(100%-3rem)] py-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-2xl font-bold text-lg shadow-lg shadow-pink-500/30 flex items-center justify-center gap-2"
      >
