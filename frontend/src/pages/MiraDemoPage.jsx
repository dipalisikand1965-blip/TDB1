        ...
        >
          <div className="mp-tray" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mp-tray-content">
              ...
              {/* ═══════════════════════════════════════════════════════════════
                  CARE ALERTS SECTION - REMOVED FROM PICKS TRAY
                  Health/Care now shown as tile near Soul Score (linked to /dashboard)
              ═══════════════════════════════════════════════════════════════ */}
              
              {/* ═══════════════════════════════════════════════════════════════
                  E021: WEATHER SUGGESTIONS SECTION
              ═══════════════════════════════════════════════════════════════ */}
              {/* Weather and Bundles removed from Picks tray - Weather shown elsewhere, Bundles not needed */}
