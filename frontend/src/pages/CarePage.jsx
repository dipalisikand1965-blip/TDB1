            ...
            <div className="space-y-4">
              ...
              {userPets.length === 0 ? (
                <Card className="p-6 text-center bg-amber-50 border-amber-200">
                  ...
                  <p className="text-sm text-amber-700 mb-4">Add your pet's profile first for personalized care</p>
          ...
          {wizardStep === 4 && requestResult && (
            <div className="text-center py-6">
              ...
              <p className="text-gray-600 mb-6">
                Your care request for <strong>{selectedPet?.name}</strong> has been submitted.
