...
const CarePage = () => {
  ...
  return (
    ...
    >
      ...
      {/* === CARE PRODUCTS === */}
      <div id="care-products-secondary" className="py-12 sm:py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          {careProducts.length > 0 ? (
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
              {careProducts.slice(0, 10).map((product) => (
                <ProductCard key={`care-secondary-${product.id}`} product={product} pillar="care" />
              ))}
            </div>
          ) : (
          ...
          {wizardStep === 4 && requestResult && (
            <div className="text-center py-6">
              ...
              <div className="flex gap-3">
                ...
                <Button onClick={() => { resetWizard(); window.location.href = `/mira-search?openConcierge=true&ticket=${requestResult?.ticket_id || ''}`; }} className="flex-1 bg-gradient-to-r from-pink-500 to-purple-600 text-white">
