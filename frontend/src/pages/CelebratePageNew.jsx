    ...
    <section style={{marginBottom:32}}>
      ...
      {!picksLoading&&picks.length>0&&(
        <div style={{display:"flex",gap:14,overflowX:"auto",paddingBottom:10,scrollbarWidth:"thin"}}>
          {picks.map((pick,i)=>{const isService=pick.entity_type==='service'||pick.type==='service';const score=pick.mira_score||0;const col=score>=80?"#16A34A":score>=70?"#C44DFF":"#6B7280";const _ri=[pick.watercolor_image,pick.image_url,pick.image].find(u=>u&&u.startsWith("http"))||null;const img=_ri&&(!_ri.includes("ai_generated") || _ri.includes("cloudinary.com"))?_ri:null;return(
