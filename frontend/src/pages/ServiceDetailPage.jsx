...
const SERVICE_VISUALS = {
  ...
  'emergency': { icon: AlertTriangle, image: '', color: 'from-red-500 to-rose-500' },
  'fitness': { icon: Dumbbell, image: '', color: 'from-green-500 to-emerald-500' },
  'celebrate': { icon: PartyPopper, image: '', color: 'from-pink-500 to-rose-500' },
  'advisory': { icon: Lightbulb, image: '', color: 'from-amber-500 to-yellow-500' },
  'default': { icon: Sparkles, image: '', color: 'from-purple-500 to-pink-500' }
};
