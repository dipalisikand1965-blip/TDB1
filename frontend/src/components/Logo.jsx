...
const Logo = ({ 
  ...
  const sizes = {
    xs: { img: 'h-10 w-10', text: 'text-sm', subtext: 'text-xs', container: 'gap-2' },
    sm: { img: 'h-12 w-12', text: 'text-base', subtext: 'text-sm', container: 'gap-2' },
    ...
    xl: { img: 'h-24 w-24', text: 'text-2xl', subtext: 'text-xl', container: 'gap-4' },
  };
