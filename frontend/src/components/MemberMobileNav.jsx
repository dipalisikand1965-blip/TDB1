        ...
        <div className="p-3 space-y-3 pb-24">
          ...
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-4">
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-2 p-3 mt-2 bg-green-500 hover:bg-green-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all touch-manipulation"
