  ...
  return (
    <div style={{ marginBottom:32 }}>
      ...
      <div style={{ display:"flex", alignItems:"flex-end", justifyContent:"space-between", marginBottom:4 }}>
        <div style={{ fontSize:20, fontWeight:800, color:G.darkText, fontFamily:"Georgia,serif" }}>Guided Farewell Paths</div>
        <button onClick={()=>setShowAll(!showAll)} style={{ background:"none", border:`1.5px solid ${G.light}`, borderRadius:20, padding:"5px 14px", fontSize:12, fontWeight:600, color:G.indigo, cursor:"pointer" }}>{showAll?"Show less":`See all ${allPaths.length}`}</button>
      </div>
      <div style={{ fontSize:12, color:G.mutedText, marginBottom:18 }}>Five paths — for when you're ready.</div>
