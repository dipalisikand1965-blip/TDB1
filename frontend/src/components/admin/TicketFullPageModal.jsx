                    ...
                    <div className="flex items-center gap-1.5 pb-0.5">
                      ...
                      <div className="hidden md:flex items-center gap-1 mr-1">
                        {['chat', 'email', 'whatsapp'].map((ch) => (
                          ...
                          >
                            {ch === 'chat' && <MessageCircle className="w-4 h-4" />}
                            {ch === 'email' && <Mail className="w-4 h-4" />}
                            {ch === 'whatsapp' && <MessageCircle className="w-4 h-4 text-green-600" />}
                          </button>
                        ))}
                      </div>
                      ...
                      <Button
                        ...
                        className={`h-10 px-4 ${isInternal ? 'bg-amber-500 hover:bg-amber-600' : 'bg-emerald-500 hover:bg-emerald-600'}`}
