  ...
  const handleSend = async () => {
    ...
    await request(venueName, {
      ...
      details: {
        ...
        venue_place_id: actualVenue?.place_id || actualVenue?.placeId || null,
        venue_city:     actualVenue?.city || null,
        venue_tdc_verified: !!actualVenue?.tdc_verified,
      ...
      metadata: {
        ...
        place_id:       actualVenue?.place_id || actualVenue?.placeId || null,
        tdc_verified:   !!actualVenue?.tdc_verified,
