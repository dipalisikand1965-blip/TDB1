...
function generateImagineCards(petName, breed, traits, pillar) {
  ...
  const CARDS = {
    ...
    go: [
      {
        icon: "🎒",
        bg: "linear-gradient(135deg,#0D3B5E,#1A5C8A)",
        name: `${petName}'s Travel Kit`,
        desc: `Breed-specific travel pack — collapsible bowl, ${breedLabel}-sized carrier, paw balm, travel tags`,
        reason: `${breedLabel}s need the right travel gear. Mira would pack exactly what ${petName} needs.`,
        cta: "Source this for me →",
      },
      {
        icon: "🌍",
      ...
      {
        icon: "✈️",
        bg: "linear-gradient(135deg,#0D9488,#0D3B5E)",
    ...
    emergency: [
      {
        ...
        name: `${petName}'s Emergency Info Card`,
        desc: `Waterproof card with ${petName}'s vet contacts, medical conditions, allergies and blood type`,
        reason: `In an emergency, every second counts. Mira imagines ${petName}'s card on every collar.`,
        cta: "Make this for me →",
      },
      {
        icon: "🩺",
        bg: "linear-gradient(135deg,#DC2626,#991B1B)",
        name: `${breedLabel} First Aid Kit`,
        desc: `Breed-specific first aid essentials — tick remover, wound spray, bandages, emergency guide`,
        reason: `${breedLabel}s have specific risks. Mira would curate the right kit for ${petName}.`,
        cta: "Source this for me →",
      },
      {
        icon: "🔴",
    ...
    play: [
      {
        icon: "🎾",
        bg: "linear-gradient(135deg,#3D2000,#7B3F00)",
        name: `${petName}'s Play Kit`,
        desc: `Toys matched to ${breedLabel} play style — ${energy === "very-high" ? "high-octane fetch and tug" : "puzzle and chew toys"} for ${petName}`,
        reason: `The right toys match the breed. Mira would choose for ${petName}'s energy level.`,
        cta: "Source this for me →",
      },
      {
        icon: "🏃",
      ...
      {
        icon: "🧸",
        bg: "linear-gradient(135deg,#C9973A,#3D2000)",
        name: `${breedLabel} Comfort Bundle`,
        desc: `Plush toys, chew treats and calm-down kit for ${petName}'s downtime after big play sessions`,
        reason: `Every ${breedLabel} needs wind-down time. Mira imagines the perfect bundle for ${petName}.`,
        cta: "Source this for me →",
      },
    ],
    paperwork: [
      {
        icon: "📋",
        bg: "linear-gradient(135deg,#0D3B5E,#0D9488)",
      ...
      {
        icon: "🪪",
        bg: "linear-gradient(135deg,#0D9488,#1A5C8A)",
      ...
      {
        icon: "🔖",
        bg: "linear-gradient(135deg,#1A5C8A,#0D3B5E)",
    ...
    adopt: [
      {
        icon: "🐾",
        bg: "linear-gradient(135deg,#1B4332,#2D6A4F)",
        name: `${petName}'s Welcome Home Kit`,
        desc: `Everything for day one — bed, bowls, collar, leash, puppy pads and starter treats`,
        reason: `Mira imagines ${petName}'s home being ready the moment they walk in.`,
        cta: "Source this for me →",
      },
      {
        icon: "📚",
        bg: "linear-gradient(135deg,#2D6A4F,#40916C)",
        name: `${breedLabel} New Parent Guide`,
        desc: `Breed-specific advice on feeding, training, socialisation and vet schedule for ${petName}'s first year`,
        reason: `Every breed is different. Mira would write ${petName}'s personal handbook.`,
        cta: "Ask Mira →",
      },
      {
        icon: "🩺",
        bg: "linear-gradient(135deg,#40916C,#1B4332)",
