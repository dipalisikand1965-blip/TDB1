...
const FIRST_STEPS = {
  ...
  emergency: [
    { id:"emerg-first-aid-kit", icon:"📦", title:"Build a First Aid Kit",
      desc:"Let Mira help you assemble the right kit for your dog's breed and weight.",
      cta:"Start Kit via Concierge® →", pillar:"emergency", intent:"first_aid_kit" },
    { id:"emerg-vet-plan", icon:"🏥", title:"Register Emergency Vet",
      desc:"Know your nearest 24hr vet before you ever need one.",
      cta:"Find 24hr Vet →", pillar:"emergency", intent:"emergency_vet" },
    { id:"emerg-safety-plan", icon:"🛡️", title:"Create Safety Plan",
      desc:"Poison contacts, vet numbers, and emergency protocol — all in one place.",
      cta:"Build Safety Plan →", pillar:"emergency", intent:"safety_plan" },
  ],
  farewell: [
    { id:"farewell-eol-plan", icon:"🕊️", title:"End-of-Life Care Plan",
      desc:"Talk through options with a Concierge® advisor — with compassion, no rush.",
      cta:"Speak to Concierge® →", pillar:"farewell", intent:"eol_plan" },
    { id:"farewell-memorial", icon:"🌷", title:"Plan a Memorial",
      desc:"A portrait, a keepsake, a ceremony — let Mira help you honour their legacy.",
      cta:"Explore Memorials →", pillar:"farewell", intent:"memorial" },
    { id:"farewell-grief", icon:"💜", title:"Grief Support",
      desc:"Losing a pet is a profound loss. Mira can connect you with compassionate support.",
      cta:"Find Grief Support →", pillar:"farewell", intent:"grief_support" },
  ],
  shop: [
    { id:"shop-mira-picks", icon:"✦", title:"See Mira's Shop Picks",
      desc:"Products filtered to your dog's breed, size and allergen profile.",
      cta:"See Mira's Picks →", pillar:"shop", intent:"mira_shop_picks" },
    { id:"shop-breed-collection", icon:"🐾", title:"Explore Breed Collection",
      desc:"Products made for your dog's specific breed and instincts.",
      cta:"Explore Collection →", pillar:"shop", intent:"breed_collection" },
  ],
  services: [
    { id:"svc-grooming", icon:"✨", title:"Book First Groom",
      desc:"A Concierge®-arranged grooming session matched to your dog's coat and breed.",
      cta:"Book Grooming →", pillar:"services", intent:"first_groom" },
    { id:"svc-vet-consult", icon:"🏥", title:"Book Vet Consultation",
      desc:"Routine check-up or a question for the vet — arranged for you by Concierge®.",
      cta:"Book Vet Consult →", pillar:"services", intent:"vet_consult" },
  ],
};
