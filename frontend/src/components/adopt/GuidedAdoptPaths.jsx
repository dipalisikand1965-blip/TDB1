  ...
  return (
    <div style={{ marginBottom:32 }}>
      ...
      <div style={{ display:"flex", alignItems:"flex-end", justifyContent:"space-between", marginBottom:4 }}>
        <div style={{ fontSize:20, fontWeight:800, color:G.darkText, fontFamily:"Georgia,serif" }}>Guided Adoption Paths</div>
      ...
      <div style={{ fontSize:12, color:G.mutedText, marginBottom:18 }}>{allPaths.length} guided paths for {petName}'s adoption journey</div>
