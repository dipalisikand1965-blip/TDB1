              ...
              <div key={place.place_id||i} style={{background:"#fff",borderRadius:16,border:`1.5px solid ${G.border}`,overflow:"hidden",transition:"transform 0.15s"}}
                ...
                <div style={{padding:"14px 16px 16px"}}>
                  ...
                  <div style={{display:"flex",gap:8}}>
                    ...
                    <button onClick={()=>{ tdc.nearme({ query: "venue", pillar:"adopt", pet }); bookViaConcierge({ service: "venue", pillar:"adopt", pet, channel:"adopt_nearme" }); onBook?.({name:place.name,pillar:"adopt",id:"rescue_partner",accentColor:G.rose})}}   style={{flex:2,background:`linear-gradient(135deg,${G.rose},${G.mid})`,color:"#fff",border:"none",borderRadius:10,padding:"8px",fontSize:12,fontWeight:700,cursor:"pointer"}}>✦ Connect via Mira</button>
                  </div>
                </div>
              </div>
            ))}
